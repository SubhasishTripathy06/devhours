...
There's no account, no server, no subscription, no internet required after the first load. Your data lives in your browser, the app installs on your phone or desktop like a native app, and it works whether you're online or not. You open it, hit start, work, hit pause, close it. That's the whole loop.
It's the kind of tool that quietly becomes part of your routine — not because it demands your attention, but because it stays out of the way and just keeps an honest count.
